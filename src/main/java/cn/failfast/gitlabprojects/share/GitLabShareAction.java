package cn.failfast.gitlabprojects.share;

import cn.failfast.gitlabprojects.common.GitLabIcons;
import cn.failfast.gitlabprojects.common.NoGitLabApiAction;
...
import cn.failfast.gitlabprojects.api.dto.NamespaceDto;
import cn.failfast.gitlabprojects.dto.GitlabServer;
...
import static cn.failfast.gitlabprojects.util.MessageUtil.showErrorDialog;
import static cn.failfast.gitlabprojects.util.MessageUtil.showInfoMessage;
...
public class GitLabShareAction extends NoGitLabApiAction {
    ...
    private static final SettingsState settingsState = SettingsState.getInstance();
